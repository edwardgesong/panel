<?php
/* Smarty version 3.1.34-dev-7, created on 2020-07-12 10:53:03
  from '/www/wwwroot/hi.mars333.com/resources/views/material/admin/user/index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5f0a7b0fbf1735_19365622',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '78121a4e675b9a4e3882bd170e4f29d377051d5f' => 
    array (
      0 => '/www/wwwroot/hi.mars333.com/resources/views/material/admin/user/index.tpl',
      1 => 1594522371,
      2 => 'file',
    ),
  ),
...
function content_5f0a7b0fbf1735_19365622 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
                ...
                <div class="card">
                 ...
                 <div class="card">
                    <div class="card-main">
                        <div class="card-inner">
                            <div class="form-group form-group-label">
                                <label class="floating-label" for="quick_create_list"> 输入 备注,number,type 快速批量创建新用户 </label>
                                <input class="form-control maxwidth-edit" id="remark" type="text">
                                <input class="form-control maxwidth-edit" id="number" type="text">
                                <input class="form-control maxwidth-edit" id="atype" type="text">
                            </div>
                        </div>
                        <div class="card-action">
                            <div class="card-action-btn pull-left">
                                <a class="btn btn-flat waves-attach waves-light" id="quick_create_list_confirm"><span
                                            class="icon">check</span>&nbsp;创建</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-main">
                        <div class="card-inner">
                            <div class="form-group form-group-label">
                                <label class="floating-label" fofiler="choosefile"> </label>
                                <input id="file" type="file" name="file">
                            </div>
                        </div>
                        <div class="card-action">
                            <div class="card-action-btn pull-left">
                                <a class="btn btn-flat waves-attach waves-light" id="upload_comfirm"><span
                                            class="icon">check</span>&nbsp;上传</a>
                            </div>
                        </div>
                    </div>
                </div>
...
,
        ...
        function quickCreatelist() {
            $.ajax({
                type: 'POST',
                url: '/admin/user/createlist',
                dataType: 'json',
                data: {
                    remark:$$getValue('remark'),
                    number:$$getValue('number'),
                    atype:$$getValue('atype'),
                },
                success: data => {
                    $("#result").modal();
                    $$.getElementById('msg').innerHTML = data.msg;
                    window.setTimeout("location.href='/admin/user'", 500000);
                },
                error: jqXHR => {
                    $("#result").modal();
                    $$.getElementById('msg').innerHTML = `${jqXHR} 发生了错误。`;
        ...
        $$.getElementById('quick_create_list_confirm').addEventListener('click', quickCreatelist)
        ...
        function upload_file() {
             ...
             $.ajax({
                ...
                success: data => {
                    $("#result").modal();
                    $$.getElementById('msg').innerHTML = data.msg;
                    window.setTimeout("location.href='/admin/user'", 5000000);
                },
                error: jqXHR => {
                    $("#result").modal();
                    $$.getElementById('msg').innerHTML = `${jqXHR} 发生了错误。`;
        ...
        $$.getElementById('upload_comfirm').addEventListener('click', upload_file)
    })
