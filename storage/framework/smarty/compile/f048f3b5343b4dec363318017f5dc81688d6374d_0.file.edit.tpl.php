<?php
/* Smarty version 3.1.34-dev-7, created on 2020-07-11 11:37:08
  from '/www/wwwroot/hi.mars333.com/resources/views/material/admin/user/edit.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5f0933e4eeb496_97003354',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f048f3b5343b4dec363318017f5dc81688d6374d' => 
    array (
      0 => '/www/wwwroot/hi.mars333.com/resources/views/material/admin/user/edit.tpl',
      1 => 1581932049,
      2 => 'file',
    ),
  ),
...
function content_5f0933e4eeb496_97003354 (Smarty_Internal_Template $_smarty_tpl) {
    ...
    <div class="container">
        <div class="col-lg-12 col-sm-12">
            <section class="content-inner margin-top-no">
                ...
                <?php if ($_smarty_tpl->tpl_vars['config']->value['enable_sub_cache'] === true) {?>
                <div class="card">
                    <div class="card-main">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-10 col-md-push-1">
                                        <a class="btn btn-block btn-brand waves-attach waves-light" href="/admin/user/<?php echo $_smarty_tpl->tpl_vars['edit_user']->value->id;?>
/cleanSubCache">清空订阅缓存</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
" readonly>
                            ...
                            <div class="form-group form-group-label">
                                ...
                                <input class="form-control maxwidth-edit" id="detect_ban_number" type="text"
                                       value="<?php if ($_smarty_tpl->tpl_vars['edit_user']->value->detect_ban_number() == 0) {?>好耶！标杆用户，没有被审计封禁过耶<?php } else { ?>太坏了，这位用户累计被封禁过 <?php echo $_smarty_tpl->tpl_vars['edit_user']->value->detect_ban_number();?>
 次呢<?php }?>" readonly>
                            </div>
