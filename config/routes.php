...
$app->group('/admin', function () {
    ...
    $this->post('/user/createlist', App\Controllers\Admin\UserController::class . ':createNewUserList');
    $this->post('/user/uploadFile', App\Controllers\Admin\UserController::class . ':uploadFile');
