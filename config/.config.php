...
$_ENV['appName'] = 'Welcome To Mars333';							//站点名称
$_ENV['baseUrl'] = 'Mars333';					//站点地址
$_ENV['subUrl'] = 'https://hi.mars333.com'.'/link/';	//订阅地址，如需和站点名称相同，请不要修改
$_ENV['muKey'] = 'zouni';								//用于校验魔改后端请求，可以随意修改，但请保持前后端一致，否则节点不能工作！
$_ENV['db_driver'] = 'mysql';							//数据库程序
$_ENV['db_host'] = 'localhost';						//数据库地址
$_ENV['db_database'] = 'hi_mars333_com';						//数据库名
$_ENV['db_username'] = 'hi_mars333_com';							//数据库用户名
$_ENV['db_password'] = 'bEHdJd6ynCzxABeD';						//用户名对应的密码
...
$_ENV['reg_protocol']='auth_sha1_v4_compatible';					//注册时默认协议
$_ENV['reg_protocol_param']='1';					//注册时默认协议参数
$_ENV['reg_obfs']='tls1.2_ticket_auth_compatible';							//注册时默认混淆方式
...
$_ENV['enable_user_email_group_show']           = true;                      //开启在群组搜寻用户信息时显示用户完整邮箱，关闭则会对邮箱中间内容打码，如 g****@gmail.com
